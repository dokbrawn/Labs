...
- после сборки CMake копирует рядом с `library_backend.exe` нужные runtime DLL, включая SQLite, чтобы приложение не падало с ошибкой вида `sqlite3.dll not found`.
